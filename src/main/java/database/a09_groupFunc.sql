...
3. 기본형식
	...
	그룹할 컬럼은 부서이고, 부서별로 급여을 확인하여 최대급여를 
	뽑아내는 것을 말한다.
...
-- ex2) 2사분기에 입사한 사람의 연봉 합산, 최대, 최소, 평균값을 출력하세요.[3조]
...
4. GROUP BY절에서 명시한 컬럼 이름은 SELECT절에서 명시하지 않아도 된다
 * */
-- 부서별평균급여
...
--ex2) 직책별 인원이 3명이상인 직책과 인원을 출력하세요. [3조]
SELECT to_char(hiredate,'MM'), max(sal) "최대급여"
FROM emp
